...
2. **Association ternaire (n-aire avec n=3)** : `PROJETER` relie les entités EMPLOYÉ, SALLE et SÉANCE, modélisant le fait qu'une séance est projetée dans une salle précise par un employé précis. Une association ternaire est ici nécessaire car l'affectation d'un employé et d'une salle pour une séance est une information atomique — on ne peut pas la décomposer en deux associations binaires sans perdre de l'information.

### II.B. Schéma du MCD

<img width="1624" height="666" alt="image" src="https://github.com/user-attachments/assets/c440af2f-558e-47d3-9c2f-6f0c6fb3e1db" />
